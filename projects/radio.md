...
<figure>
 ...
 \
 \
 I used the program [PDW](https://discriminator.nl/pdw/index-en.html) and [VB Audio Virtual Cable](https://vb-audio.com/Cable/) in order to pipe the audio from SDR# into the program. A couple moments later, there was a bunch of numbers and text popping up. The first thing I noticed was these messages were all related to patients and hospitals in my area. After a couple minutes of analysis, I concluded this was my local hospital paging network. I could see pages relating to emergency xrays or broken HVAC systems. This was very interesting, but also a bit scary as these tranmissions with some personal info was in the clear. Lets hope our hospitals switch to an encrypted system in the future.
 \
 \
